...
//    }
    ...
    void issueCoupon_InsufficientStock() {
        ...
        Coupon coupon = new Coupon(couponId, "10% 할인 쿠폰", "RATE", BigDecimal.valueOf(10.0), LocalDate.parse("2025-08-01"), LocalDate.parse("2025-08-31"), 0);
        ...
        // assertEquals("쿠폰 재고가 부족합니다.", result.getDetail());
